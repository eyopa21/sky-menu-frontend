<template>
  <div id="features" class="mx-0 mt-8 p-6 lg:mx-20 lg:px-20">
    <div class="grid grid-cols-12 justify-center gap-4">
      ...
      <div class="col-span-12 mt-6 p-0 md:col-span-12 lg:col-span-4 lg:mt-0 lg:pb-8 lg:pr-8">
      ...
      <div class="col-span-12 mt-6 p-0 md:col-span-12 lg:col-span-4 lg:mt-0 lg:pb-8">
        <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 226, 237, 0.2), rgba(172, 180, 223, 0.2)), linear-gradient(180deg, rgba(172, 180, 223, 0.2), rgba(246, 158, 188, 0.2))">
          <div class="h-full bg-surface-0 p-4 dark:bg-surface-900" style="border-radius: 8px">
            ...
            <div class="mb-1 mt-6 text-xl font-semibold text-surface-900 dark:text-surface-0">
              Well Documented
            </div>
      ...
      <div class="col-span-12 mt-6 p-0 md:col-span-12 lg:col-span-4 lg:mt-0 lg:pr-8">
      ...
      <div class="lg-4 col-span-12 mt-6 p-0 md:col-span-12 lg:col-span-4 lg:mt-0">
      ...
      <div
        class="col-span-12 my-20 p-2 md:p-20"
        style="border-radius: 20px; background: linear-gradient(0deg, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.6)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, #efe1af 0%, #c3dcfa 100%)"
      >
        <div class="flex flex-col items-center justify-center p-4 text-center md:py-0">
          <div class="mb-2 text-3xl font-semibold text-gray-900">
            Joséphine Miller
          </div>
          <span class="text-2xl text-gray-600">Peak Interactive</span>
          <p class="sm:line-height-2 md:line-height-4 mt-6 text-2xl text-gray-900" style="max-width: 800px">
